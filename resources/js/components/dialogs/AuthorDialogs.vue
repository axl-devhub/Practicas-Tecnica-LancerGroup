...
watch(() => props.showDetails, async (isOpen) => {
    if (isOpen && props.selectedAuthor) {
            ...
            <form @submit.prevent="handleCreate" class="space-y-4">
                <div>
                    ...
                    <Input 
                        ...
                        required 
                    />
                    <p v-if="createForm.errors.name" class="text-sm text-red-500 mt-1">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        :class="{ 'border-red-500': createForm.errors.lastName }"
                        required 
                    />
                    <p v-if="createForm.errors.lastName" class="text-sm text-red-500 mt-1">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        required 
                    />
                    <p v-if="createForm.errors.country" class="text-sm text-red-500 mt-1">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        required 
                    />
                    <p v-if="createForm.errors.birthDate" class="text-sm text-red-500 mt-1">
            ...
            <form @submit.prevent="handleUpdate" class="space-y-4">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        required 
                    />
                    <p v-if="editForm.errors.name" class="text-sm text-red-500 mt-1">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        :class="{ 'border-red-500': editForm.errors.lastName }"
                        required 
                    />
                    <p v-if="editForm.errors.lastName" class="text-sm text-red-500 mt-1">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        required 
                    />
                    <p v-if="editForm.errors.country" class="text-sm text-red-500 mt-1">
                ...
                <div>
                    ...
                    <Input 
                        ...
                        required 
                    />
                    <p v-if="editForm.errors.birthDate" class="text-sm text-red-500 mt-1">
            ...
            <div v-else-if="authorDetails" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div v-if="authorDetails.books && authorDetails.books.length > 0">
                        <h3 class="font-semibold text-lg mb-4">Libros Publicados</h3>
